...
# 20 "src/sat/bitcoindbg.c" 2


# 21 "src/sat/bitcoindbg.c"
int clausecounter = 0;
...
int main(int argc, char *argv[])
{
  ...
  if(fscanf(
# 130 "src/sat/bitcoindbg.c" 3 4
           stdin
# 130 "src/sat/bitcoindbg.c"
                , "SAT\n") != 0)
  {
    fprintf(
# 132 "src/sat/bitcoindbg.c" 3 4
           stderr
# 132 "src/sat/bitcoindbg.c"
                 , "error: expected: SAT\n");
    exit(1);
  }
  ...
  while(1)
  {
    ...
    {
      rv = fscanf(
# 140 "src/sat/bitcoindbg.c" 3 4
                 stdin
# 140 "src/sat/bitcoindbg.c"
                      , "%d", &var);
      if(rv == -1)
      {
        break;
      ...
      {
        fprintf(
# 147 "src/sat/bitcoindbg.c" 3 4
               stderr
# 147 "src/sat/bitcoindbg.c"
                     , "error: var=%d rv=%d\n", var, rv);
        exit(1);
      }
